...
RSpec.describe Admin::Handymen::ProfilesController, type: :controller do
  ...
  describe 'PUT #update_basic_profile' do
    let(:param) do
      {
        name: "update_test",
        phone: "13112345678",
    ...
    context 'with valid params' do
      it 'updates successful' do
        put :update_basic_profile, id: handyman.id, profile: param
    ...
    context 'with invalid params' do
      it 'fails if the handyman is not exists' do
        ...
        expect{ put :update_basic_profile, id: handyman_id, profile: param }.to raise_error(ActiveRecord::RecordNotFound)
      end
  ...
  describe 'PUT #update_email' do
    ...
    context 'with valid params' do
      it 'updates email successfully' do
        put :update_email, id: handyman.id, profile: param
    ...
    context 'with invalid params' do
      it 'fails if email exists' do
        ...
        put :update_email, id: handyman.id, profile: { email: exist_email }
      ...
      it 'fails if email format is invalid' do
        ...
        put :update_email, id: handyman.id, profile: { email: invalid_email }
  ...
  describe 'PUT #update_address' do
    ...
    context 'with valid address' do
      it 'update address successful' do
        put :update_address, id: handyman.id, profile: param
      ...
      it 'does not create new address if primary_address exists' do
        ...
        expect{ put :update_address, id: handyman.id, profile: param }.not_to change{ Address.count }
      ...
      it 'create new address if primary_address not exists' do
        ...
        expect{ put :update_address, id: handyman.id, profile: param}.to change{ Address.count }.by(1)
      end
    end
